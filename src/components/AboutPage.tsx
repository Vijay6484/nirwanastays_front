  ...
  const values = [
    {
      ...
      description: 'We are committed to delivering exceptional experiences that exceed expectations.'
    },
    {
      icon: TreePine,
      title: 'Environmental Responsibility',
      description: 'Sustainable practices and eco-friendly operations are at the core of everything we do.'
    },
    {
      icon: Users,
      title: 'Guest-Centric Approach',
      description: 'Every decision we make is focused on creating memorable moments for our guests.'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl sm:text-2xl mb-8 max-w-3xl mx-auto animate-slide-up">
            Where Nature Meets Luxury, Creating Unforgettable Memories Since 2015
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-8">Our Story</h2>
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                <p>
                  Born from a passion for nature and hospitality, Nirwana Stays began as a dream to create 
                  a sanctuary where guests could disconnect from the chaos of city life and reconnect with 
                  the beauty of the natural world.
                </p>
                <p>
                  Located on the pristine shores of Pawna Lake, our resort has grown from a small camping 
                  site to a premier destination offering diverse accommodations and experiences. We believe 
                  that true luxury lies not just in comfort, but in the memories created and the peace found 
                  in nature's embrace.
                </p>
                <p>
                  Today, we continue to evolve while staying true to our core values of sustainability, 
                  authenticity, and exceptional guest service. Every sunrise over the lake reminds us why 
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white rounded-3xl p-10 shadow-xl animate-fade-in">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To provide exceptional hospitality experiences that celebrate the beauty of nature 
                while promoting sustainable tourism practices. We strive to create a haven where 
                guests can rejuvenate their spirits and create lasting memories.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl animate-slide-up">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To become the leading eco-luxury resort destination in India, setting new standards 
                for sustainable hospitality while preserving the natural beauty that makes our 
                location so special for future generations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-emerald-700">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-emerald-100 text-lg">Numbers that reflect our commitment to excellence</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <div key={index} className="text-center p-8 rounded-3xl bg-gradient-to-b from-emerald-50 to-white shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-emerald-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Ready to Experience Nirwana?</h2>
