  ...
  const highlights = [
    {
      ...
      description: "Direct access to pristine Pawna Lake",
    },
    {
      icon: Mountain,
      title: "Scenic Views",
      description: "Breathtaking sunrise and sunset vistas",
    },
    {
      icon: Sun,
      title: "Year Round",
      description: "Perfect weather throughout the year",
    },
    {
      icon: TreePine,
            ...
            <div className="relative animate-slide-up">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-xl">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center"></div>
                </div>
              </div>
            </div>
          </div>
