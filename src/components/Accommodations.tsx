...
import { MapPin, Users, Wifi, Car, ChevronLeft, ChevronRight } from 'lucide-react';
...
const ImageSlider = ({ images }: { images: string[] }) => {
  ...
  return (
    <div 
      ref={sliderRef}
      className="relative w-full h-36 sm:h-48 md:h-56 lg:h-64 overflow-hidden"
  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-6 flex flex-col flex-1">
        ...
        <p className="text-gray-600 mb-2 sm:mb-6 leading-relaxed text-xs sm:text-base">
