...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <a
        href="tel:9021408308"
        className="fixed bottom-24 right-6 z-50 w-16 h-16 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 transform hover:scale-110 animate-pulse"
